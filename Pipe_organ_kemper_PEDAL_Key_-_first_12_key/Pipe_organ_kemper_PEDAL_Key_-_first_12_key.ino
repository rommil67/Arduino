/**
 * Pipe organ kemper PEDAL Key - first 12 key
...
NoteButton buttons[] = {
    ...
    // for UNO , nano
    {A0, {note(C, 2), CHANNEL_3}},
    {A1, {note(Db, 2), CHANNEL_3}},
    {A2, {note(D, 2), CHANNEL_3}},
    {A3, {note(Eb, 2), CHANNEL_3}},
    {A4, {note(E, 2), CHANNEL_3}},
    {A5, {note(F_, 2), CHANNEL_3}},
    {2, {note(Gb, 2), CHANNEL_3}},
    {3, {note(G, 2), CHANNEL_3}},
    {4, {note(Ab, 2), CHANNEL_3}},
    {5, {note(A, 2), CHANNEL_3}},
    {6, {note(Bb, 2), CHANNEL_3}},
    {7, {note(B, 2), CHANNEL_3}},
    {8, {note(C, 3), CHANNEL_3}},
    {9, {note(Db, 3), CHANNEL_3}},
   // {10, {note(D, 3), CHANNEL_3}},
   // {11, {note(Eb, 3), CHANNEL_3}},
   // {12, {note(E, 3), CHANNEL_3}},
 //  {13, {note(F, 3), CHANNEL_3}},
